...
export default function InvitationForm() {
  ...
  return (
    <div className="bg-muted h-svh flex flex-col items-center justify-center p-6 md:p-10">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border rounded-md p-4 bg-white shadow-inner text-sm whitespace-pre-wrap">
                ...
                <p className="mb-4">{localData.closingStatement ?  localData.closingStatement : <i className="text-sm text-center text-gray-500">Pesan Penutup</i>}</p>
