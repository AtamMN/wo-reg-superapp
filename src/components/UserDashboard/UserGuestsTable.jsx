"use client";
import ViewGuestDialog from "../SAdminDashboard/ViewGuestDialog";
...
export default function GuestsTable() {
  ...
  // Fetch attendance - HANYA USER SENDIRI
  useEffect(() => {
    const fetchAttendance = async () => {
      ...
      try {
        ...
        // Ambil data attendance user sendiri saja
        const userAttendanceRef = ref(db, `attendance/${currentUser.uid}`);
